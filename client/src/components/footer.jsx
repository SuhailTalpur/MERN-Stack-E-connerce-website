        ...
        <div class="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
          <div class="lg:w-1/4 md:w-1/2 w-full px-4">
            ...
            <nav class="list-none mb-10">
              <li>
                <a class="text-gray-400 hover:text-white">Men's Fashion</a>
              </li>
              <li>
                <a class="text-gray-400 hover:text-white">Women's Fashion</a>
              </li>
              <li>
                <a class="text-gray-400 hover:text-white">Kids' Fashion</a>
              </li>
              <li>
          ...
          <div class="lg:w-1/4 md:w-1/2 w-full px-4">
            <h2 class="title-font font-medium text-white tracking-widest text-sm mb-3">POLICIES</h2>
            <nav class="list-none mb-10">
              <li>
              ...
              <li>
                <a class="text-gray-400 hover:text-white">Validation</a>
              </li>
            </nav>
          </div>
        </div>
